...
func (t *Uint32Tree) Insert(key uint32, value any) {
	t.g.Insert(key, value)
}

// Search returns the value associated with key from the tree.
func (t *Uint32Tree) Search(key uint32) (any, bool) {
...
func (t *Uint32Tree) Update(key uint32, callback func(any, bool) any) {
...
func (t *Uint32Tree) NewScanner(key uint32) *Uint32Cursor {
	return &Uint32Cursor{t.g.NewScanner(key)}
}
...
// modification of the locked node. The leaf node is only unlocked after
// closing the Cursor.
func (t *Uint32Tree) NewScannerAll() *Uint32Cursor {
	return &Uint32Cursor{t.g.NewScannerAll()}
}

// Uint32Cursor is used to enumerate key-value pairs from the tree in
// ascending order.
type Uint32Cursor struct {
	g *GenericCursor[uint32, any]
}
...
func (c *Uint32Cursor) Close() error { return c.g.Close() }
...
func (c *Uint32Cursor) Pair() (uint32, any) { return c.g.Pair() }
...
// the Pair method.
func (c *Uint32Cursor) Scan() bool { return c.g.Scan() }
