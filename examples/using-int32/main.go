...
func main() {
	...
	fmt.Printf("Creating a B+Tree of order %d, using int32 values as keys.\n", int(*order))
	t, err := gobptree.NewInt32Tree(int(*order))
	if err != nil {
	...
	// slice of int32 values from [0 to N).
